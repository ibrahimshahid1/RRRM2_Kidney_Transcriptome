...
clusters.type <- list(
  ...
  Proximal   = c("PT"),
  Distal     = c("TAL_LOH", "DCT_early", "DCT_late", "CD", "Other"),
  Immune     = c("Immune"),
  Stroma     = c("Fibroblast")
)
...
if (EXP_REMOVE_OTHER) {
  ...
  clusters.type <- list(
    Glomerular = c("Podocyte", "Endothelial", "Mesangial"),
    Proximal   = c("PT"),
    Distal     = c("TAL_LOH", "DCT_early", "DCT_late", "CD"),
    Immune     = c("Immune"),
    Stroma     = c("Fibroblast")
  )
...
group.markers <- list(
  ...
  Proximal   = mk_pt,
  Distal     = unique(c(mk_tal_final, mk_dct_early_final, mk_dct_late_final, mk_cd_final)),
  Immune     = NULL,
  Stroma     = NULL
)
