...
\begin{tabularx}{\textwidth}{p{0.34\textwidth}rrrrX}
\toprule
Analysis & DCT1 top decile OR & DCT1 top decile q & DCT2 bottom decile OR & DCT2 bottom decile q & Read \\
\midrule
Row-level primary $p<0.05$ & 1.51 & $9.96\times10^{-12}$ & 1.29 & $1.15\times10^{-5}$ & DCT1 stronger at row level \\
Row-level composite sites excluded & 1.38 & $1.86\times10^{-6}$ & 1.33 & $1.15\times10^{-5}$ & similar magnitude \\
Row-level one site per parent gene & 1.49 & $6.40\times10^{-4}$ & \textbf{1.68} & $\mathbf{3.96\times10^{-6}}$ & DCT2-bottom-decile larger \\
Parent-gene Fisher (any $p<0.05$ suppressed site) & 1.52 & $1.52\times10^{-4}$ & \textbf{1.82} & $\mathbf{2.64\times10^{-8}}$ & DCT2-bottom-decile larger \\
\bottomrule
\end{tabularx}
\end{table}
